...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Ayus-maxx/SpyMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/shivi_musicc")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Friends_forever_zonen")
